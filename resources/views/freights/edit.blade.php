...
<form action="{{ route('frete.update', $freight->id) }}" method="POST">
	...
	<div class="form-group col-md-12">
		...
		<textarea name="description" class="form-control" rows="5" required>{{$freight->description}}</textarea>
	</div>	    
    ...
    <div class="form-group col-md-5">
	    ...
	    <div class="input-group">
	    	...
	    	<input type="text" name="price" value="{{$freight->price}}" class="form-control" required>
